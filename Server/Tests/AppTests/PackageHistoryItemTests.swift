...
final class PackageHistoryItemTests: XCTestCase {
    ...
    func testDecodePackageHistoryItem() throws {
        guard let fileURL = Bundle.module.url(forResource: "historyItem", withExtension: "json", subdirectory: "MockData/Packages") else {
    ...
    func testDecodePackageHistoryItems() throws {
        guard let fileURL = Bundle.module.url(forResource: "historyItems", withExtension: "json", subdirectory: "MockData/Packages") else {
            XCTFail("File not found")
            return
        }
